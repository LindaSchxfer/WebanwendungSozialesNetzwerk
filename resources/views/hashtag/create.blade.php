...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Neues Hashtag anlegen</div>
                ...
                <div class="card-body">
                    <form action = "/hashtag" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control {{$errors->has('color') ? 'border-danger' : ''}}" id="color" name="color" rows="5">{{old('color')}}</textarea>
